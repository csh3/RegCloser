...
parser.add_argument('-f', required=True, help='Whether the library is used for local assembly or making tab files.')
...
if flag in ['2', '3']:
    fout1 = open('tab%s.txt'%library,'w')
...
with open('%s_remap_R1.sam'%library) as fin_1:
    with open('%s_remap_R2.sam'%library) as fin_2:
        ...
        while(True):
            ...
            if flag in ['2', '3'] and mappedNum1==1 and mappedNum2==1:
            ...
            if flag in ['1', '3'] and not args.nr:
                if mappedNum1==1:
